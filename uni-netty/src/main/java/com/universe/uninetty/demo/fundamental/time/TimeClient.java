...
//                            ch.pipeline().addLast(new TimeClientSolutionOneHandler(),new TimeSolution2Decoder());
                            ch.pipeline().addLast(new TimeClientSolutionOneHandler(),new TimeAnotherDecoder());
                        }
                    })
