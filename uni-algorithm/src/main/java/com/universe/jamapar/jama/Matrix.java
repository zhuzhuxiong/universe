 ...
 *
 * Java矩阵类提供了数值的基本运算 线性代数。
 * 各种构造函数从二维空间创建矩阵 双精度浮点数数组。
 * 各种“gets” “sets”提供对子矩阵和矩阵元素的访问。
 * 几种方法 实现基本的矩阵运算，包括矩阵加法和 乘法、矩阵规范和元素对元素的数组操作。
 * 阅读和打印矩阵的方法也包括在内。所有的 在这个版本的矩阵类中，运算涉及实矩阵。
 * 复杂矩阵可能会在未来的版本中被处理。
 * <p>
